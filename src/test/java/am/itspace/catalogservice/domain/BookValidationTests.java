...
public class BookValidationTests {
    ...
    void whenAllFieldsCorrectThenValidationSucceeds() {
        var book = new Book(null,"1234567890", "Title", "Author", 9.90, 0);
    ...
    void whenIsbnNotDefinedThenValidationFails() {
        var book = new Book(null,"", "Title", "Author", 9.90, 0);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
    ...
    void whenIsbnDefinedButIncorrectThenValidationFails() {
        var book = new Book(null,"a234567890", "Title", "Author", 9.90, 0);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
    ...
    void whenTitleIsNotDefinedThenValidationFails() {
        var book = new Book(null, "1234567890", "", "Author", 9.90, 0);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
        assertThat(violations).hasSize(1);
        assertThat(violations.iterator().next().getMessage())
    ...
    void whenAuthorIsNotDefinedThenValidationFails() {
        var book = new Book(null,"1234567890", "Title", "", 9.90, 0);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
        assertThat(violations).hasSize(1);
        assertThat(violations.iterator().next().getMessage())
    ...
    void whenPriceIsNotDefinedThenValidationFails() {
        var book = new Book(null,"1234567890", "Title", "Author", null, 0);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
        assertThat(violations).hasSize(1);
        assertThat(violations.iterator().next().getMessage())
    ...
    void whenPriceDefinedButZeroThenValidationFails() {
        var book = new Book(null,"1234567890", "Title", "Author", 0.0, 0);
        Set<ConstraintViolation<Book>> violations = validator.validate(book);
        assertThat(violations).hasSize(1);
        assertThat(violations.iterator().next().getMessage())
